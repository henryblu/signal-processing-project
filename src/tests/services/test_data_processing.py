...
class test_data_processing(unittest.TestCase):
    def test_input_checker(self):
        ...
        sample_rate, data = DataProcessing.input_checker(
            r"C:\Users\henry\OneDrive - University of Helsinki\Documents\University files\Comp"
            + r" sci\year 2\data structures and algoithms project course\signal-processing-pro"
            + r"ject\src\data\StarWars3.wav"
        )
    ...
    def test_get_data(self):
        ...
        sample_rate, data = DataProcessing.get_data(
            (
                r"C:\Users\henry\OneDrive - University of Helsinki\Documents\University files\Comp"
                + r" sci\year 2\data structures and algoithms project course\signal-processing-pro"
                + r"ject\src\data\StarWars3.wav"
